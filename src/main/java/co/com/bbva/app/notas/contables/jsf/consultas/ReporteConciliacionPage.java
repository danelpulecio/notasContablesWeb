        ...
        try {
            ...
            if (cantFest == 0) {
                ...
                if (Integer.valueOf(hour) <= 21) {
                    ...
                    nuevoMensaje(FacesMessage.SEVERITY_WARN, "La generación de la conciliación puede ejecutarse los días hábiles antes de las 10 pm, en caso contrario el procesamiento no será exitoso.");
                }
            } else {
                nuevoMensaje(FacesMessage.SEVERITY_WARN, "La generación de la conciliación puede ejecutarse los días hábiles antes de las 10 pm, en caso contrario el procesamiento no será exitoso.");
            }
